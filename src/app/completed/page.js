...
import { safeFormatDate, safeFormatTime, isValidDate } from '../../utils/dateUtils';
    ...
    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6">
      <div>
        ...
        <select
          ...
          className={`w-full sm:w-auto border rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 ${
            isDark 
      ...
      <div>
        ...
        <input
          ...
          className={`w-full sm:w-auto sm:min-w-[200px] border rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 ${
            isDark 
          ...
          >
            <div className={`px-6 py-4 border-b ${
              ...
              <h3 className="text-lg font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                {date === 'unknown-date' ? 'Unknown Date' : format(new Date(date), 'MMMM d, yyyy')}
              </h3>
            </div>
            <ul>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className={`text-base sm:text-lg font-semibold break-words ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>{task.title}</h4>
                      {task.description && (
                        <p className={`mt-1 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>{task.description}</p>
                      )}
                      <div className="flex flex-wrap items-center mt-3 gap-2 sm:gap-4 text-sm">
                        ...
                        <span className={isDark ? 'text-gray-400' : 'text-gray-500'}>
                          Completed at {task.completedAt && isValidDate(task.completedAt) 
                    ...
                    <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 sm:space-x-0">
                      <button
    ...
    <div className="max-w-6xl mx-auto py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6">
      <div className="relative mb-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">Completed Tasks</h1>
