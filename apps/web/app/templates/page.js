  ...
  return (
    <form onSubmit={handleSubmit} className={`space-y-6 backdrop-blur-sm p-8 rounded-2xl shadow-lg mb-8 border transition-all duration-300 slide-up stagger-2 hover-lift ${
      ...
      <div className="flex items-center justify-between">
        <h2 className={`text-2xl font-bold bg-linear-to-r bg-clip-text text-transparent ${
          isDark 
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2 ml-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-linear-to-r from-green-500 to-green-600
...
function SuccessMessage({ message }) {
  return message ? (
    <div className="mb-8 p-4 bg-linear-to-r from-green-50 to-green-100 border border-green-200
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8 slide-up stagger-1">
        <h1 className="text-4xl font-bold bg-linear-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-3">
          Templates
        </h1>
        <p className={`text-lg ${
