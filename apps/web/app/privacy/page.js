      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              We retain your information for as long as your account is active or as needed to provide you services. You may delete your account at any time from your account settings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Our service may integrate with third-party services (such as Google for authentication). These services have their own privacy policies, and we encourage you to review them.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              If you have any questions about this Privacy Policy, please contact us at: itaskorg+support@gmail.com
            </p>
          </section>
        </div>
      </div>
