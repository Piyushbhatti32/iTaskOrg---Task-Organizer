  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        } rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl transform transition-all duration-300 scale-100 animate-in fade-in zoom-in-95`}
      >
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  } rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none transition-all duration-300`}
                >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border ${
                  isDark
                    ? "border-gray-700 bg-gray-800/50 text-gray-100 placeholder:text-gray-500"
                    : "border-gray-200 bg-white text-gray-900 placeholder:text-gray-400"
                } rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300`}
              />
            </div>
              ...
              <textarea
                ...
                className={`w-full border ${
                  isDark
                    ? "border-gray-700 bg-gray-800/50 text-gray-100 placeholder:text-gray-500"
                    : "border-gray-200 bg-white text-gray-900 placeholder:text-gray-400"
                } rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300`}
                rows="4"
              />
            </div>
            ...
            <div>
              ...
              <UserAssignmentField
                ...
                onUsersChange={(users) =>
                  updateFormData("assignedUsers", users)
                }
...
function TaskInput({ onAdd, currentUser }) {
  ...
  return (
    <form
      ...
      } overflow-hidden mb-8 transition-all duration-300 hover:shadow-xl ${
        isDark ? "hover:bg-gray-900/80" : "hover:bg-white/80"
      }`}
    >
      <div className="p-5">
      ...
      {isExpanded && (
        <div
          ...
          } p-5 space-y-4 ${isDark ? "bg-gray-900/50" : "bg-white/50"}`}
        >
          {/* Template selector */}
          <div>
            <label
            ...
            <div className="relative">
              ...
              <select
                ...
                } rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none transition-all duration-300`}
              >
                <option value="">Select a template...</option>
                {templates.map((template) => (
                  <option key={template.id} value={template.id}>
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full border ${
                isDark
                  ? "border-gray-700 bg-gray-800/50 text-gray-100 placeholder:text-gray-500"
                  : "border-gray-200 bg-white/50 text-gray-900 placeholder:text-gray-400"
              } rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300`}
              rows="3"
            />
          </div>
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 border ${
                    isDark
                      ? "border-gray-700 bg-gray-800/50 text-gray-100"
                      : "border-gray-200 bg-white/50 text-gray-900"
                  } rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300`}
                />
              </div>
            </div>
      ...
      <div
        className={`border-t ${
          isDark ? "border-gray-800" : "border-gray-100"
        } p-5 flex justify-end ${isDark ? "bg-gray-900/50" : "bg-white/50"}`}
      >
        <button
          type="submit"
          disabled={!formData.title.trim()}
    ...
    <div className="ml-0 sm:ml-9 mt-3 pb-4">
      ...
      >
        <input
          ...
          } border rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300`}
        ...
        <button
          ...
          } rounded-xl font-medium transition-all duration-300 hover:shadow-md active:scale-95`}
        >
          Add
        </button>
      </form>
        ...
        {task.subtasks?.map((st) => (
          <li key={st.id} className="flex items-center gap-3 group">
            <div className="relative shrink-0">
              ...
              />
              <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-purple-500 rounded opacity-0 peer-checked:opacity-100 transition-opacity duration-300" />
            </div>
            <span
              className={`text-sm transition-all duration-300 flex-1 wrap-break-words ${
                st.completed
            ...
            <button
              ...
              className={`sm:opacity-0 sm:group-hover:opacity-100 p-1 ${
                isDark
...
export default function TasksPage() {
  ...
  const handleAddTask = (taskData) => {
    const finalTaskData = {
      ...
      assignedUsers:
        taskData.assignedUsers.length > 0
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case "high":
        return {
          bg: "bg-linear-to-r from-red-500/10 to-red-600/10",
          text: "text-red-600",
          ring: "ring-red-500/20",
        };
      case "medium":
        return {
          bg: "bg-linear-to-r from-yellow-500/10 to-yellow-600/10",
          text: "text-yellow-600",
          ring: "ring-yellow-500/20",
        };
      case "low":
        return {
          bg: "bg-linear-to-r from-green-500/10 to-green-600/10",
          text: "text-green-600",
          ring: "ring-green-500/20",
        };
      default:
        return {
          bg: "bg-linear-to-r from-gray-500/10 to-gray-600/10",
          text: "text-gray-600",
      ...
      <div className="relative">
        <div
          className={`absolute inset-0 rounded-3xl -z-10 ${
            isDark
              ? "bg-linear-to-br from-gray-900/30 via-gray-800/30 to-gray-900/30"
              : "bg-linear-to-br from-blue-50 via-purple-50/50 to-pink-50"
          }`}
        />
        <div
          className={`absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-40 -z-10 ${
            isDark ? "opacity-20" : "opacity-40"
          }`}
        />
        <h1 className="text-2xl lg:text-4xl font-bold mb-2 bg-linear-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
          Tasks
        </h1>
        <p
        ...
        {showDeleteConfirmation && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
              className={`relative z-10 ${
                isDark ? "bg-gray-900" : "bg-white"
              } rounded-3xl p-8 max-w-md w-full shadow-2xl transform transition-all duration-300 scale-100 animate-in fade-in zoom-in-95`}
            >
              ...
              <div className="text-center mb-6">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 animate-ping">
                    <div className="w-20 h-20 mx-auto bg-linear-to-r from-red-500/20 to-yellow-500/20 rounded-full"></div>
                  </div>
                  <div className="relative w-20 h-20 mx-auto mb-4 bg-linear-to-r from-red-500 to-yellow-500 rounded-full flex items-center justify-center shadow-lg animate-in spin-in-180 duration-500">
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-2xl bg-linear-to-r from-red-600 to-yellow-600 text-white font-semibold hover:shadow-xl hover:shadow-red-500/25 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    <Trash2 className="w-5 h-5" />
                    Yes, Delete!
                  </span>
                  <div className="absolute inset-0 bg-linear-to-r from-yellow-600 to-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className="relative">
                  {/* Animated rings */}
                  <div className="absolute inset-0 animate-ping">
                    <div className="w-20 h-20 mx-auto bg-linear-to-r from-blue-500/20 to-purple-500/20 rounded-full"></div>
                  </div>
                  <div className="relative w-20 h-20 mx-auto mb-4 bg-linear-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-lg animate-in spin-in-180 duration-500">
                ...
                >
                  Great job! Are you ready to mark this task as completed? You
                  can always undo this action later.
                </p>
              </div>
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 rounded-2xl bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
        ...
        <div className="space-y-4">
          {tasks.length === 0 && (
            ...
            >
              <div className="text-gray-400 text-7xl mb-6 animate-bounce">
                📝
              </div>
              <p
                className={`${
            ...
            return (
              <div
                ...
                className={`group ${
                  ...
                  isDark ? "hover:bg-gray-900/80" : "hover:bg-white/80"
                } hover-lift slide-up stagger-${Math.min(index + 1, 5)}`}
              >
                <div className="p-5">
                  <div className="flex items-start sm:items-center gap-3">
                    <button
                      onClick={() => handleToggleTaskCompletion(task.id)}
                      className={`mt-1 sm:mt-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-300 shrink-0 ${
                        task.completed
                          ? "bg-linear-to-r from-blue-500 to-purple-500 border-transparent scale-105"
                    ...
                    {editingId === task.id ? (
                      <div className="flex-1 flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <input
                          ...
                          } border rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                          value={editTitle}
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-linear-to-r from-blue-500 to-purple-500 text-white font-medium hover:from-blue-600 hover:to-purple-600 transition-all duration-300"
                          >
                            Save
                          </button>
                          <button
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                          <span
                            className={`text-base sm:text-lg transition-all duration-300 wrap-break-words ${
                              task.completed
                                ? `line-through ${
                          ...
                          {task.priority && (
                            <span
                              className={`text-xs px-2 sm:px-3 py-1 sm:py-1.5 rounded-full ring-1 ${priorityColors.bg} ${priorityColors.text} ${priorityColors.ring} font-medium transition-all duration-300 self-start`}
                            >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {task.assignedUsers.map((user) => {
                          ...
                          return (
                            <div
                              key={user.id}
                              className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full border text-xs font-medium ${
